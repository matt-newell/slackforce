...
exports.execute = (req, res) => {
    ...
    force.chatter(oauthObj, '/chatter/users/me/messages/', {body = 'Chatter is coming for you!', recipients = ['005700000036eCO']})
        .then(data => {
            console.log('Dude what does mine say.... Sweet');
        })
        .catch(error => {
            console.log('Dude what does mine say.... Dude');
        });
